...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center">
      ...
      {/* judul */}
      <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-2">Hi, I'am Syawalan Finanda</h1>

      {/* sub judul */}
      <p className="text-gray-600 text-lg md:text-xl mb-6">Fullstack Developer</p>
